...
```
## Insert Data into Table - job_history
```sql
...
## Write a query to get all employee details from the employee table order by first name in descending 
```sql
